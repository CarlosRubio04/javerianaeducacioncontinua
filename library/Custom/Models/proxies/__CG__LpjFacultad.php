 ...
 */
class LpjFacultad extends \LpjFacultad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LpjFacultad' . "\0" . 'vnombre', '' . "\0" . 'LpjFacultad' . "\0" . 'iestado', '' . "\0" . 'LpjFacultad' . "\0" . 'pkId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LpjFacultad $proxy) {
