 ...
 */
class LpjCategoria extends \LpjCategoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LpjCategoria' . "\0" . 'vnombre', '' . "\0" . 'LpjCategoria' . "\0" . 'iestado', '' . "\0" . 'LpjCategoria' . "\0" . 'pkId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LpjCategoria $proxy) {
